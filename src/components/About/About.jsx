    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        {/* Greeting */}
          ...
          {/* Resume Button */}
          <a href="https://drive.google.com/file/d/1R_q5Rl5nGd4lUJKw8kG9bUodJKlP1FT_/view?usp=sharing" target='_blank' rel='noopner noreferrer' className='inline-block text-white py-3 px-8 rounded-full mt-5 text-lg font-bold transition duration-300 transform hover:scale-105' style={{
